package com.example.tugasakhir.view.screen.item_sepeda
...
import com.example.tugasakhir.view.components.ItemSepeda


@Composable
fun ItemSepedaScreen(
    modifier: Modifier = Modifier,

) {
    ItemSepedaContent(listSepeda = dummySepeda)
} 


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ItemSepedaContent(
    listSepeda:  List<Sepeda>,
    modifier: Modifier = Modifier,
){
    Column  (
    ){
        ...
        LazyVerticalGrid(
            ...
            items(listSepeda, key = {it.title}) { sepeda ->
                ItemSepeda(sepeda = sepeda)
            }
        }
    }
}
